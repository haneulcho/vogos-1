...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$_POST['de_admin_company_owner']}',
                ...
                de_index_video_use            = '{$_POST['de_index_video_use']}',
                de_index_video_src            = '{$_POST['de_index_video_src']}',
                de_index_video_width          = '{$_POST['de_index_video_width']}',
                de_index_video_height         = '{$_POST['de_index_video_height']}',
