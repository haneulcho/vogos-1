...
CREATE TABLE IF NOT EXISTS `g5_shop_cart` (
  ...
  `io_price` float(11) NOT NULL DEFAULT '0',
  `ct_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ct_ip` varchar(25) NOT NULL DEFAULT '',
  `ct_send_cost` float(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `g5_shop_default` (
  ...
  `de_index_video_use` tinyint(4) NOT NULL DEFAULT '0',
  `de_index_video_src` int(12) NOT NULL DEFAULT '0',
  `de_index_video_width` int(11) NOT NULL DEFAULT '0',
  `de_index_video_height` int(11) NOT NULL DEFAULT '0',  
  ...
  `de_member_reg_coupon_price` float(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `g5_shop_ddmaddress` (
  ...
  `ddm_place1` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `g5_shop_order` (
  ...
  `od_name_last` varchar(50) NOT NULL DEFAULT '',
  `od_email` varchar(100) NOT NULL DEFAULT '',
  `od_tel` varchar(20) NOT NULL DEFAULT '',
  `od_hp` varchar(20) NOT NULL DEFAULT '',
  `od_country` varchar(255) NOT NULL default '',
  `od_city` varchar(255) NOT NULL default '',
  `od_zip` char(12) NOT NULL DEFAULT '',
  `od_addr1` varchar(100) NOT NULL DEFAULT '',
  `od_addr2` varchar(100) NOT NULL DEFAULT '',
  `od_deposit_name` varchar(20) NOT NULL DEFAULT '',
  `od_b_name` varchar(50) NOT NULL DEFAULT '',
  `od_b_name_last` varchar(50) NOT NULL DEFAULT '',
  `od_b_tel` varchar(20) NOT NULL DEFAULT '',
  `od_b_hp` varchar(20) NOT NULL DEFAULT '',
  `od_b_country` varchar(255) NOT NULL DEFAULT '',
  `od_b_city` varchar(255) NOT NULL DEFAULT '',
  `od_b_zip` char(12) NOT NULL DEFAULT '',
  ...
  `od_cart_price` float(11) NOT NULL DEFAULT '0',
  `od_cart_coupon` int(11) NOT NULL DEFAULT '0',
  `od_send_cost` float(11) NOT NULL DEFAULT '0',
  `od_send_cost2` float(11) NOT NULL DEFAULT '0',
  `od_send_coupon` int(11) NOT NULL DEFAULT '0',  
  `od_receipt_price` float(11) NOT NULL DEFAULT '0',
  `od_cancel_price` float(11) NOT NULL DEFAULT '0',
  `od_receipt_point` int(11) NOT NULL DEFAULT '0',
  `od_refund_price` float(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `g5_shop_order_address` (
  ...
  `ad_name_last` varchar(255) NOT NULL DEFAULT '',
  ...
  `ad_zip` char(12) NOT NULL DEFAULT '',
